"""모든 rule 디렉토리를 스캔해 docs/RULES.md 카탈로그 생성. python generate_rules_index.py"""
import glob, yaml, sys
sys.stdout.reconfigure(encoding="utf-8")

DIRS = [("인적 배치", "placement_rules"), ("작업 조건", "condition_rules"),
...
open("docs/RULES.md", "w", encoding="utf-8").write("\n".join(lines))
print(f"docs/RULES.md 생성 — {total}개 규칙")
